 ...
 * artwork is simple an {@linkplain Artwork.Builder#imageUri(android.net.Uri) image} along with
 * some metadata.
 *
...
public class Artwork {
     ...
     *
     * @see Artwork.Builder#imageUri(android.net.Uri)
     */
    ...
    /**
     * Returns the activity {@link android.content.Intent} that will be started when the user clicks
     * for more details about the artwork, or null if the artwork doesn't have one.
     *
     * @see Artwork.Builder#viewIntent(android.content.Intent)
     */
     ...
     * </pre>
     *
     * The only required field is {@linkplain #imageUri(android.net.Uri) the image URI}, but you
    ...
    public static class Builder {
        ...
        /**
         * Sets the activity {@link android.content.Intent} that will be
         * {@linkplain android.content.Context#startActivity(android.content.Intent) started} when
    ...
    /**
     * Deserializes an artwork object from a {@link android.os.Bundle}.
     */
    ...
    /**
     * Serializes this artwork object to a {@link org.json.JSONObject} representation.
     */
    ...
    /**
     * Deserializes an artwork object from a {@link org.json.JSONObject}.
     */
